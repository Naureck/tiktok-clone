      ...
      <header className={style.DivContainerHeader}>
         <div className={style.DivWrapperHeader}>
            ...
            <div className={style.DivUploadAndUser}>
               <Button upload to={routesConfig.upload} leftIcon={<FontAwesomeIcon icon="fas fa-plus" />} btnNormal>
                  Upload
               </Button>
               {currentUser ? (
                  <>
                     <Tippy content="Message">
                        <div className={style.DivMessageContainer}>
                           <Button to={routesConfig.message} className={style.MessIcon} btnNormal>
                              <MessageIcon />
                           </Button>
                        </div>
                     </Tippy>
                     ...
                     <Tippy content="Inbox">
                        <div className={style.DivInboxContainer}>
                           <Button className={style.IbIcon} btnNormal>
                              <InboxIcon />
                           </Button>
